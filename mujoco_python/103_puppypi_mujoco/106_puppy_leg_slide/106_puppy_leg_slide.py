...
# MUJOCO gflw의 원점은 아래 왼쪽, 즉 위로 y 증가 오른쪽으로 x 증가 
s1 = Slider(10, 339, 0.55)
s2 = Slider(10, 290, 0.675)
s3 = Slider(10, 250, 0.55)
s4 = Slider(10, 210, 0.675)
s5 = Slider(10, 170, 0.55)
s6 = Slider(10, 130, 0.625)
s7 = Slider(10, 90, 0.55)
s8 = Slider(10, 50, 0.625)
...
def create_overlay(model, data):
    ...
    add_overlay(topleft,f"rb hip  {0}",'%.2f' % desired_positions[0])  # dispaly slider 
    add_overlay(topleft,f"rb knee {1}",'%.2f' % desired_positions[1])  
    add_overlay(topleft,f"lb hip  {2}",'%.2f' % desired_positions[2])  
    add_overlay(topleft,f"lb knee {3}",'%.2f' % desired_positions[3])  
    add_overlay(topleft,f"rf hip  {4}",'%.2f' % desired_positions[4])  
    add_overlay(topleft,f"rf knee {5}",'%.2f' % desired_positions[5])  
    add_overlay(topleft,f"lf hip  {6}",'%.2f' % desired_positions[6])  
    add_overlay(topleft,f"lf knee {7}",'%.2f' % desired_positions[7])  
